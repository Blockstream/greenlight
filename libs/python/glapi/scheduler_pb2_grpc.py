...
from glapi import scheduler_pb2 as glapi_dot_scheduler__pb2
...
class SchedulerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
                ...
                request_serializer=glapi_dot_scheduler__pb2.RegistrationRequest.SerializeToString,
                response_deserializer=glapi_dot_scheduler__pb2.RegistrationResponse.FromString,
                )
        self.Recover = channel.unary_unary(
                '/scheduler.Scheduler/Recover',
                request_serializer=glapi_dot_scheduler__pb2.RecoveryRequest.SerializeToString,
                response_deserializer=glapi_dot_scheduler__pb2.RecoveryResponse.FromString,
                )
        self.GetChallenge = channel.unary_unary(
                '/scheduler.Scheduler/GetChallenge',
                request_serializer=glapi_dot_scheduler__pb2.ChallengeRequest.SerializeToString,
                response_deserializer=glapi_dot_scheduler__pb2.ChallengeResponse.FromString,
                )
        self.Schedule = channel.unary_unary(
                '/scheduler.Scheduler/Schedule',
                request_serializer=glapi_dot_scheduler__pb2.ScheduleRequest.SerializeToString,
                response_deserializer=glapi_dot_scheduler__pb2.NodeInfoResponse.FromString,
                )
        self.GetNodeInfo = channel.unary_unary(
                '/scheduler.Scheduler/GetNodeInfo',
                request_serializer=glapi_dot_scheduler__pb2.NodeInfoRequest.SerializeToString,
                response_deserializer=glapi_dot_scheduler__pb2.NodeInfoResponse.FromString,
                )
...
def add_SchedulerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Register': grpc.unary_unary_rpc_method_handler(
                    servicer.Register,
                    request_deserializer=glapi_dot_scheduler__pb2.RegistrationRequest.FromString,
                    response_serializer=glapi_dot_scheduler__pb2.RegistrationResponse.SerializeToString,
            ),
            'Recover': grpc.unary_unary_rpc_method_handler(
                    servicer.Recover,
                    request_deserializer=glapi_dot_scheduler__pb2.RecoveryRequest.FromString,
                    response_serializer=glapi_dot_scheduler__pb2.RecoveryResponse.SerializeToString,
            ),
            'GetChallenge': grpc.unary_unary_rpc_method_handler(
                    servicer.GetChallenge,
                    request_deserializer=glapi_dot_scheduler__pb2.ChallengeRequest.FromString,
                    response_serializer=glapi_dot_scheduler__pb2.ChallengeResponse.SerializeToString,
            ),
            'Schedule': grpc.unary_unary_rpc_method_handler(
                    servicer.Schedule,
                    request_deserializer=glapi_dot_scheduler__pb2.ScheduleRequest.FromString,
                    response_serializer=glapi_dot_scheduler__pb2.NodeInfoResponse.SerializeToString,
            ),
            'GetNodeInfo': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNodeInfo,
                    request_deserializer=glapi_dot_scheduler__pb2.NodeInfoRequest.FromString,
                    response_serializer=glapi_dot_scheduler__pb2.NodeInfoResponse.SerializeToString,
            ),
    }
...
class Scheduler(object):
    ...
    def Register(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/scheduler.Scheduler/Register',
            glapi_dot_scheduler__pb2.RegistrationRequest.SerializeToString,
            glapi_dot_scheduler__pb2.RegistrationResponse.FromString,
    ...
    def Recover(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/scheduler.Scheduler/Recover',
            glapi_dot_scheduler__pb2.RecoveryRequest.SerializeToString,
            glapi_dot_scheduler__pb2.RecoveryResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetChallenge(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/scheduler.Scheduler/GetChallenge',
            glapi_dot_scheduler__pb2.ChallengeRequest.SerializeToString,
            glapi_dot_scheduler__pb2.ChallengeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Schedule(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/scheduler.Scheduler/Schedule',
            glapi_dot_scheduler__pb2.ScheduleRequest.SerializeToString,
            glapi_dot_scheduler__pb2.NodeInfoResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetNodeInfo(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/scheduler.Scheduler/GetNodeInfo',
            glapi_dot_scheduler__pb2.NodeInfoRequest.SerializeToString,
            glapi_dot_scheduler__pb2.NodeInfoResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
