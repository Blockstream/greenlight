...
class PairDeviceRequest(google.protobuf.message.Message):
    ...
    RESTRS_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["csr", b"csr", "desc", b"desc", "device_name", b"device_name", "restrs", b"restrs", "session_id", b"session_id"]) -> None: ...
...
class PairDeviceResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["creds", b"creds", "device_cert", b"device_cert", "device_key", b"device_key", "rune", b"rune", "session_id", b"session_id"]) -> None: ...

global___PairDeviceResponse = PairDeviceResponse

@typing_extensions.final
class PairingQr(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    DATA_FIELD_NUMBER: builtins.int
    data: builtins.str
    """Holds the data that the new device shows the old device during a pairing 
    request. The data is of the form: gl-pairing:<session_id>
    """
    def __init__(
        self,
        *,
...
class ApprovePairingRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["device_name", b"device_name", "node_id", b"node_id", "pubkey", b"pubkey", "restrs", b"restrs", "rune", b"rune", "session_id", b"session_id", "sig", b"sig", "timestamp", b"timestamp"]) -> None: ...
...
class ApprovePairingResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["node_id", b"node_id", "rune", b"rune", "session_id", b"session_id"]) -> None: ...
...
class SignerRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["approve_pairing", b"approve_pairing", "request", b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["approve_pairing", b"approve_pairing", "request", b"request", "request_id", b"request_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["request", b"request"]) -> typing_extensions.Literal["approve_pairing"] | None: ...
...
class SignerResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["approve_pairing", b"approve_pairing", "empty", b"empty", "response", b"response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["approve_pairing", b"approve_pairing", "empty", b"empty", "request_id", b"request_id", "response", b"response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["response", b"response"]) -> typing_extensions.Literal["empty", "approve_pairing"] | None: ...
