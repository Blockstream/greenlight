...
class PairDeviceRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["csr", b"csr", "desc", b"desc", "device_name", b"device_name", "restrs", b"restrs", "session_id", b"session_id"]) -> None: ...
...
class ApprovePairingRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["device_name", b"device_name", "node_id", b"node_id", "pubkey", b"pubkey", "restrs", b"restrs", "rune", b"rune", "session_id", b"session_id", "sig", b"sig", "timestamp", b"timestamp"]) -> None: ...
