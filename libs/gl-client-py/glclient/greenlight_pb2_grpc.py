...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in glclient/greenlight_pb2_grpc.py depends on'
...
class NodeStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.LspInvoice = channel.unary_unary(
...
class NodeServicer(object):
    ...
    def LspInvoice(self, request, context):
...
def add_NodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'LspInvoice': grpc.unary_unary_rpc_method_handler(
                    servicer.LspInvoice,
