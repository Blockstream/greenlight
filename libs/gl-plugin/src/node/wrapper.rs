...
use anyhow::Error;
use cln_grpc;
use cln_grpc::pb::ListpeerchannelsResponse;
...
impl Node for WrappedNodeServer {
    ...
    async fn subscribe_block_added(
        &self,
        request: tonic::Request<pb::StreamBlockAddedRequest>,
    ...
    async fn subscribe_channel_open_failed(
        &self,
        request: tonic::Request<pb::StreamChannelOpenFailedRequest>,
    ...
    async fn subscribe_channel_opened(
        &self,
        request: tonic::Request<pb::StreamChannelOpenedRequest>,
    ...
    async fn subscribe_connect(
        &self,
        request: tonic::Request<pb::StreamConnectRequest>,
    ...
    async fn subscribe_custom_msg(
        &self,
        request: tonic::Request<pb::StreamCustomMsgRequest>,
    ...
    async fn subscribe_channel_state_changed(
        &self,
        request: tonic::Request<pb::StreamChannelStateChangedRequest>,
